...
print('\n\n')
print('*****')
print('***** start of script: make_preds.py')
print('*****')
print('\n\n')
...
sendtofile(excluded_dir,"train_data-before.csv",train_data, verbose=True)
...
print(train_data.shape)
print(train_data.head())
sendtofile(excluded_dir,"train_data-after.csv",train_data, verbose=True)
#print(1/0)
# find the outliers
...
if True and True:
    ...
    sendtofile(excluded_dir,'predictions_lgbm.csv',submission_lgbm, verbose=True)
    ...
    sendtofile(excluded_dir,'predictions_rf_gb.csv',submission_rf_gb, verbose=True)
    ...
    sendtofile(excluded_dir,'predictions_rf_gb_lgbm.csv',submission_rf_gb_lgbm, verbose=True)
    ...
    sendtofile(excluded_dir,'predictions_lr_rf_gb_lgbm.csv',submission_lr_rf_gb_lgbm, verbose=True)


print('\n\n')
print('*****')
print('***** end of script: make_preds.py')
print('*****')
print('\n\n')
